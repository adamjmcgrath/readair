  ...
  $.ui.resizable = function(element, options) {
    ...
    o.defaultTheme = {
      ...
      'ui-resizable-s': {
		...
		borderTop: aBorder,
		backgroundImage: 'url(assets/img/bg/resize-btn.png), url(assets/img/bg/resize.png)',
		backgroundRepeat: 'no-repeat, repeat-x',
		backgroundPosition: '50% 50%, 0 0'
	  },
      // custom e
      'ui-resizable-e': { cursor: 'move', width: '22px', bottom: '0px', height: '22px' },
